  ...
  return (
    <div className="md:px-6 lg:px-8 w-full">
      <header className="h-[3.5rem] w-full flex flex-row shrink-0 items-center px-4 md:px-6 relative">
        <h1 className="mr-6 flex font-bold text-lg lg:text-xl">cine-vault.io</h1>

        <Sheet>
          <SheetTrigger asChild>
            <Button variant="outline" className="ml-auto lg:hidden flex flex-row items-center gap-2 bg-transparent">
          ...
          <SheetContent side="left">
            ...
            <a href="/" className={`flex items-center gap-2 text-sm ${isActive("/") ? "text-blue-500" : "text-black dark:text-white"}`}>
                <House />
                <span>Home</span>
              </a>

              <a href="/saved-content" className={`flex items-center gap-2 text-sm ${isActive("/saved-content") ? "text-blue-500" : "text-black dark:text-white"}`}>
                <Star />
                <span>Saved</span>
              </a>

              <a href="/watched-content" className={`flex items-center gap-2 text-sm ${isActive("/watched-content") ? "text-blue-500" : "text-black dark:text-white"}`}>
                <Tv />
                <span>Watched</span>
              </a>
              ...
              <div className="flex items-center gap-4 mt-4">
                <ModeToggle />
                <Button className="text-xs">EN/PT-BR</Button>
              </div>
            </div>
